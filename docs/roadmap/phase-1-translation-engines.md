...
Core implementation is delivered, but the default-engine decision remains open. CAT-Translate is explicitly experimental: it remains slow and low-quality in real use despite runtime fixes.
