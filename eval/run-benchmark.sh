...
printf '  adb logcat -s "EngineBenchmarkTest:*" "ArchitectureSpikeTest:*" "BubbleDetectionBenchmarkTest:*" "LlamaBridge:*" "LlamaTranslationBridge:*" "LlamaJNI:*" "OpusMtTranslator:*" "OpusMtTranslationBridge:*"\n\n'

step_start 4 'device test'
adb logcat -c

adb logcat -s "EngineBenchmarkTest:*" "ArchitectureSpikeTest:*" "BubbleDetectionBenchmarkTest:*" "LlamaBridge:*" "LlamaTranslationBridge:*" "LlamaJNI:*" "OpusMtTranslator:*" "OpusMtTranslationBridge:*" > "$LOGCAT_FILE" 2>/dev/null &
LOGCAT_PID=$!
